    ...
    <div>
      <form>
        ...
        <div>
          ...
          ></input>
          <label className="checkboxName">English</label>
          <input
            type="checkbox"
            onChange={(eventObj) => {
              if (eventObj.target.checked == true) {
          ...
          ></input>
          <label className="checkboxName">Telugu</label>
          <input
            type="checkbox"
            onChange={(eventObj) => {
              if (eventObj.target.checked == true) {
          ...
          ></input>
          <label className="checkboxName">Hindi</label>
        </div>
        <div>
        ...
        <div>
          <button
            ...
            onClick={() => {
              ...
              alert(
                `${salutation} ${firstName} ${lastName} from ${stateSelect} knows ${languagesKnown.english == true ? "English " : ""},${languagesKnown.telugu == true ? "Telugu " : ""} and ${languagesKnown.hindi == true ? "Hindi " : ""} got Total Marks are ${totalMarks} with ${percentage.toFixed(2)}% and ${grade} grade.`);
            }}>Calculate</button>
        </div>
      </form>
    </div>
